...
Implemented the main color theme file [`nord`](https://github.com/nordtheme/xresources/blob/develop/src/nord). (@svengreb, #1, 4125f919)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/xresources/blob/develop/README.md#installation) and in the [project wiki](https://github.com/nordtheme/xresources/wiki).

<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/nordtheme/xresources/develop/src/assets/scrot-colortest.png" /><br />
  </picture>
